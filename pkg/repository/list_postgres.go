...
func (r *ListPostgres) Create(userId int, list TodoApp.TodoList) (int, error) {
	tx, err := r.db.Begin()
	if err != nil {
		return 0, err
	}
...
func (r *ListPostgres) GetAll(userId int) ([]TodoApp.TodoList, error) {
...
func (r *ListPostgres) GetById(userId, listId int) (TodoApp.TodoList, error) {
...
func (r *ListPostgres) Update(userId, listId int, input TodoApp.UpdateListInput) error {
	...
	params = append(params, listId, userId)
